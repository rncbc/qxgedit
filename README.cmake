...
1. You need CMake 3.10 or newer to build QXGEdit

2. Unpack the QXGEdit sources somewhere, or checkout the repository, 
   and create a build directory. For instance, using a command line shell:
   
$ tar -xvzf Downloads/qxgedit-x.y.z.tar.gz
$ cd qxgedit-x.y.z
$ mkdir build
...
The CMake build system for QXGEdit is experimental. It will take a while
until it becomes stable and fully tested. You can help providing feedback, 
please send a report containing your problems to the QXGEdit development 
mailing list, https://lists.sourceforge.net/mailman/listinfo/qxgedit-devel
