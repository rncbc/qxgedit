...
#ifndef __qxgeditKnob_h
#define __qxgeditKnob_h

#include <QDial>


//-------------------------------------------------------------------------
// qxgeditKnob - A better QDial for everybody

class qxgeditKnob : public QDial
{
	Q_OBJECT
...
public:
	...
	// Constructor.
	qxgeditKnob(QWidget *pParent = nullptr);
	// Destructor.
	~qxgeditKnob();
...
#endif  // __qxgeditKnob_h

// end of qxgeditKnob.h
