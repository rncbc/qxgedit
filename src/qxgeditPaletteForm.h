...
#ifndef __qxgeditPaletteForm_h
#define __qxgeditPaletteForm_h
...
namespace Ui { class qxgeditPaletteForm; }


class qxgeditPaletteForm: public QDialog
{
	Q_OBJECT

public:

	qxgeditPaletteForm(QWidget *parent = nullptr,
		const QPalette& pal = QPalette());

	virtual ~qxgeditPaletteForm();
...
private:
	...
	Ui::qxgeditPaletteForm *p_ui;
	Ui::qxgeditPaletteForm& m_ui;
...
class qxgeditPaletteForm::PaletteModel : public QAbstractTableModel
{
	Q_OBJECT
...
class qxgeditPaletteForm::ColorDelegate : public QItemDelegate
{
public:
...
class qxgeditPaletteForm::ColorButton : public QPushButton
{
	Q_OBJECT
...
class qxgeditPaletteForm::ColorEditor : public QWidget
{
	Q_OBJECT
...
private:
	...
	qxgeditPaletteForm::ColorButton *m_button;
	bool  m_changed;
};
...
class qxgeditPaletteForm::RoleEditor : public QWidget
{
	Q_OBJECT
...
#endif // __qxgeditPaletteForm_h

// end of qxgeditPaletteForm.h
